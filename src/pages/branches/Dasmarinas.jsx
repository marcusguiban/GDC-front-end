...
const DentistDasmarinas = () => {
  ...
  return (
    ...
    <Container sx={{py:10}}>
    <Typography variant="h4" align="center" color={"palevioletred"}> Guiban Dental Clinic Dasmarinas </Typography>
    <Grid container>
      <Grid item md={6} sm={12} align="center">
        ...
        <Typography variant="h5" align="center" color={"palevioletred"} sx={{py:5}}> We are located at L.E.A Building 084, Palapala, Sampaloc 1, Dasmarinas, Cavite </Typography>
      </Grid>
      <Grid item md={6} sm={12} align="center">
...
export default DentistDasmarinas;