...
import map from "../../images/molinoMap.jpg";
...
const DentistMolino = () => {
  ...
  return (
    ...
    <Container sx={{py:10}}>
    <Typography variant="h4" align="center" color={"palevioletred"}> Guiban Dental Clinic Molino </Typography>
    <Grid container>
      <Grid item md={6} sm={12} align="center">
        ...
        <Typography variant="h5" align="center" color={"palevioletred"} sx={{py:5}}> We are located at 3rd Floor, Avon Bldg., L. 2 Blk. 3, Molino Road, Molino 3, Molino, Bacoor City, Cavite  </Typography>
      </Grid>
      <Grid item md={6} sm={12} align="center">
