...
const DentistCarmona = () => {
  ...
  return (
    ...
    <Container sx={{py:10}}>
    <Typography variant="h4" align="center" color={"palevioletred"}> Guiban Dental Clinic Carmona </Typography>
    <Grid container>
      <Grid item md={6} sm={12} align="center">
        ...
        <Typography variant="h5" align="center" color={"palevioletred"} sx={{py:5}}> We are located at Lot 3 Blk 5 GF JabezTech Bldg. Macaria Business Center Carmona, Cavite </Typography>
      </Grid>
      <Grid item md={6} sm={12} align="center">
